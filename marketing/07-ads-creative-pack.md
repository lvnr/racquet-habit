# Ads Creative Pack — Concepts, Copy, Specs, Testing

Everything needed to launch the first two testing cycles on Meta, then Pinterest and TikTok. Concepts reference P#/V# from files 05–06.

## §1 First testing cycle (Meta, 3:2:2 = 12 ads)

Three concepts × two formats (video / static-or-carousel) × two hooks:
...
## §3 Static ad layouts (build in Higgsfield; templates in file 08 §F)
...
## §4 Platform specs cheat-sheet (2026)

| | Meta | TikTok | Pinterest |
|---|---|---|---|
| Feed static | 4:5, 1440×1800 | — | 2:3, 1000×1500 |
| Video | 9:16 1080×1920, 15–30s | 9:16, 15–30s (Spark: any organic) | 6–15s, 2:3 or 9:16 |
| Safe zones | top 14%, bottom 20–35%, sides 6% | top 10%, right 10%, bottom 20% | bottom 25% |
| Copy limits | primary ~125 visible chars | caption ≤100 chars (~40 visible) | title ≤100, desc ≤500 |
| Sound | captions mandatory (design sound-off-safe) | sound-on native | mostly viewed muted |
...
## §6 Landing & funnel notes

- Ads land on collection pages (capsule ads → capsule collection URL), not the homepage; UTM everything.
- PDPs already answer sizing/production/delivery — mirror those answers in ad comments early (comment management = conversion work on TikTok/Meta).
- Post-purchase email flow via Fourthwall: order → care-label humor + "wear it, tag it" → review ask. Reviews become month-2 ad creative.

## §7 Budget pacing recap

Month 1 ≈ $1.5K: warm-up $200 → Meta conversions $50/day → Pinterest $20/day. Month 2 ≈ $3.3K: Meta $70/day + Pinterest $20 + TikTok $20. Month 3 ≈ $4.4–5.2K: ASC $90–120/day + Pinterest $25 + TikTok $30. Scale only +20% per 2–3 days; scale the *winning creative*, not more ad sets.

## §8 AI-content compliance (do not skip)

- **Meta:** toggle the AI self-certification for any photorealistic AI human (Soul ID characters included). Auto "Made with AI" labels are fine; unflagged detection risks disapprovals on a young ad account.
- **TikTok:** switch on the AIGC label for AI-real-looking footage; unlabeled + detected = throttling and strikes ladder.
- **Pinterest:** auto-labels "AI modified"; nothing to do, but expect it.
- **Practical mix:** lead ads with real creator UGC and real product macros where possible; use AI for scenic/editorial and variation volume. Never depict a real identifiable person via AI, and keep NY's synthetic-performer disclosure in mind for anything testimonial-shaped that's fully synthetic.
- Keep generated imagery honest about physical product details (brand rule; also an FTC/returns problem if violated).

## §9 Weekly scorecard template

```
Week of ____          Spend  CPM   CTR   CPC   CPA   ROAS  Notes
Meta prospecting      ____   ____  ____  ____  ____  ____  top ad: ____
Meta retargeting      ____   ____  ____  ____  ____  ____
Pinterest             ____   ____  ____  ____  ____  ____  top keyword: ____
TikTok Spark          ____   ____  ____  ____  ____  ____  top post: ____
Organic: IG +__ foll / best post ____ | TT +__ / best ____ | PIN __ views
Email +__ subs | Orders __ | AOV $__ | Fatigue flags: ____
Action for next week: 1) ____ 2) ____ 3) ____
```
